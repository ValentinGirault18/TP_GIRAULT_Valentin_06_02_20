   ...
   printf(" Choisissez le chapitre dans lequel vous souhaite vous rendre.\n");
	...
	while (fin !=1)
	{
		...
		while (choixDeplacement1!=1 && choixDeplacement1!=2 && choixDeplacement1!=3)
		{
			...
			{
				printf ("Vous entrez dans le chapitre 1 'Les merveilles'. \n \n");
			...
			{
				printf ("Vous entrez dans le chapitre 2 'la realite'. \n \n");
			...
			{
				printf ("Vous entrez dans le chapitre 3 'le desespoir'. \n \n");
